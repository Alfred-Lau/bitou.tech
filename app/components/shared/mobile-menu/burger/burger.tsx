  ...
  <LazyMotion features={domAnimation}>
    ...
    >
      <span className="relative block h-7 w-7">
        <m.span
          className="absolute top-1 right-0 block h-0.5 w-7 rounded-full bg-black transition-colors duration-200"
          variants={{
            initial: {
              top: 4,
              display: "block",
        ...
        />
        <m.span
          className="absolute bottom-1 right-0 block h-0.5 w-7 rounded-full bg-black transition-colors duration-200"
          variants={{
            initial: {
              bottom: 4,
              display: "block",
